...
$global:scaffolderTabExpansion["MvcScaffolding.Json"] = $global:scaffolderTabExpansion["MvcScaffolding.Xml"] = $global:scaffolderTabExpansion["MvcScaffolding.DataViews"] = {
