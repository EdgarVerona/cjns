...
$outputFolderName = Join-Path $outputFolderName "Xml"
...
Write-Host "--ModelTypeName = $foundModelType.Name"
Write-Host "--PrimarySectionName = $PrimarySectionName"
Write-Host "--ViewName = $ViewName"
